...
class MLProductListDependencyNoVariantsFilter extends MLProductListDependency {
	public function manipulateQuery() {
		if ( MLProduct::gi()->hasMasterItems()) {
			$this->getQuery()->where("p.products_master_model is null or p.products_master_model=''");
		}
		return $this;
	}	
}