...
if (!MSIE || MSIE > 8) {
     ...
     * jquery.hammer.js
     *
     * @description This jQuery plugin is just a small wrapper around the Hammer() class.
     *              It also extends the Manager.emit method by triggering jQuery events.
     *              The Hammer instance is stored at $element.data("hammer").
     * @author      https://github.com/hammerjs/jquery.hammer.js
     * @license     The MIT License (MIT)
     * @copyright   Copyright (c) 2014 Hammer.js
     * @example     `$(element).hammer(options).bind("pan", myPanHandler);`
     * @version     2.0.0
     */
    (function (factory) {
