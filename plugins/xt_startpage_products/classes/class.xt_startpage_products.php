...
class xt_startpage_products {
	...
	public function _getParams() {
		...
		$tabs[] = array(
				...
				'url_short' => true,
				'params' => "load_section=xt_startpage_attached_products&plugin=xt_startpage_products&shop_id='+edit_id+'",
		...
		$tabs[] = array(
				'url' => 'adminHandler.php',
				'url_short' => true,
				'params' => "load_section=xt_startpage_products_to_shop&plugin=xt_startpage_products&shop_id='+edit_id+'",
