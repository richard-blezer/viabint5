...
try {
  ...
  if((!$rSetting) and ($resultset_config->fields["config_value"]=="true")) {
     ...
     $rSetting->exo_auth_mail=$rSOAP->aData['customers_email_address'];
  ...
  $db->Execute("UPDATE ".TABLE_PLUGIN_PRODUCTS." SET plugin_status='0' WHERE plugin_id='".(int)$exo_plugin_id."';");     
}

$db->Execute("UPDATE ".TABLE_PLUGIN_CONFIGURATION." SET config_value='".$msg."' WHERE plugin_id='".(int)$exo_plugin_id."' and config_key='EXORBYTE_STATUS_MESSAGE';");
