...
class MLProductListDependencyOnlyMainArticlesFilter extends MLProductListDependency {
	public function manipulateQuery() {
		if ( MLProduct::gi()->hasMasterItems()) {
			$this->getQuery()->where("p.products_master_flag != 1 OR p.products_master_flag IS NULL");
		}
		return $this;
	}	
}