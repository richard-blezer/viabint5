...
V5.04a 25 Mar 2008   (c) 2000-2008 John Lim (jlim#natsoft.com.my). All rights reserved.
 ...
 29 okt 2008: multiple database on same host, fix by Mario Zanier, xt:Commerce GmbH mzanier@xt-commerce.com
*/ 
...
class ADODB_mysql extends ADOConnection {
	...
	var $__db = array(); // mzanier, fixed adodb multiple db bug
...
//		return "from_unixtime(unix_timestamp($date)+$fraction)";
	...
	//global $ADODB_COUNTRECS;
		//if($ADODB_COUNTRECS) 
		$this->SelectDB($this->__db[$this->_connectionID]); // mzanier, multiple database fix
