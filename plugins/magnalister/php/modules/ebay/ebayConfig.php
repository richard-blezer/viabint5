 ...
 *
 * -----------------------------------------------------------------------------
 * $Id: ebayConfig.php 167 2013-02-08 12:00:00Z tim.neumann $
 *
...
if (!$auth['state']) {
	...
	$form['import']['fields']['defaultpayment']['values'] = array_merge(array('matching' => ML_COMPARISON_SHOPPING_LABEL_STD), $form['import']['fields']['defaultpayment']['values']);
