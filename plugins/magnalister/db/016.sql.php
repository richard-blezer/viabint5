...
# eBay-Modul: 
function extend_ebay_properties_table_16() {
	if (!MagnaDB::gi()->columnExistsInTable('Transferred', TABLE_MAGNA_EBAY_PROPERTIES))
		MagnaDB::gi()->query('ALTER TABLE `'.TABLE_MAGNA_EBAY_PROPERTIES.'` ADD COLUMN `Transferred` tinyint(1) unsigned NOT NULL DEFAULT \'0\' AFTER Verified');
...
$functions[] = 'extend_ebay_properties_table_16';
$functions[] = 'addTopTen';
