...
/*
 ...
 # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 #
 # @version $Id: box_cart_bottom.php 4547 2011-03-09 09:13:47Z mzanier $
...
if(XT_COUPONS_CART_BOX == 'true'){
	$arr_coupon = $_SESSION['sess_coupon'];
	
	if(is_array($arr_coupon)) {
		if($arr_coupon['coupon_token_code'] != '') {
			echo "<br><b>".TEXT_COUPON_AKTIV.':&nbsp;'.$arr_coupon['coupon_token_code'].'</b>';
		} else if($arr_coupon['coupon_code'] != '') {
			echo "<br><b>".TEXT_COUPON_AKTIV.':&nbsp;'.$arr_coupon['coupon_code'].'</b>';
		}
	}else{
