 ...
 *
 * -----------------------------------------------------------------------------
 * $Id: german.php 665 2015-04-08 14:59:45Z Soprex $
 *
...
define('ML_BUTTON_LABEL_DELETE_ENTIRE_PROTOCOL', 'Gesamtes Log l&ouml;schen');
...
define('ML_RICARDO_PROMOTION_COST', 'Promotions are not for free. Please check prices on Ricardo.');
...
define('ML_RICARDO_ERROR_START_PRICE', 'Start price must be greater than zero.');
define('ML_RICARDO_ERROR_INCREMENT', 'Increment must be greater than zero.');
...
//define('ML_RICARDO_ERROR_DATE', 'Date attribute is mandatory.');
