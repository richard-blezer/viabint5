 ...
 *
 * -----------------------------------------------------------------------------
 * $Id: yategoConfig.php 585 2015-01-18 16:58:25Z derpapst $
 *
...
if (false === getDBConfigValue('yatego.imagepath', $_MagnaSession['mpID'], false)) {
	$form['checkin']['fields']['imagepath']['default'] = SHOP_URL_POPUP_IMAGES;
	setDBConfigValue('yatego.imagepath', $_MagnaSession['mpID'], $form['checkin']['fields']['imagepath']['default'], true);
}
if (false === getDBConfigValue('yatego.imagepath.absolut', $_MagnaSession['mpID'], false)) {
	$form['checkin']['fields']['imagepathabsolut']['default'] = SHOP_FS_POPUP_IMAGES;
	setDBConfigValue('yatego.imagepath.absolut', $_MagnaSession['mpID'], $form['checkin']['fields']['imagepathabsolut']['default'], true);
}
...
if (isset($_GET['kind']) && ($_GET['kind'] == 'ajax')) {
	...
	$cG->sortKeys(array(
		'ftp', 'checkin', 'shop', 'lang', 'stats', 'price', 'shipping', 'inventoryupdate', 'checkinstandards', 'import', 'mail'
	));
